...
class ChatTimeFormatTest {
  ...
  void formatsTodayAsClock() {
    Instant now =
        ZonedDateTime.of(LocalDate.of(2026, 8, 22), LocalTime.of(15, 0), ChatTimeFormat.ZONE)
            .toInstant();
    Instant msg =
        ZonedDateTime.of(LocalDate.of(2026, 8, 22), LocalTime.of(14, 32), ChatTimeFormat.ZONE)
            .toInstant();
  ...
  void formatsYesterday() {
    Instant now =
        ZonedDateTime.of(LocalDate.of(2026, 8, 22), LocalTime.of(10, 0), ChatTimeFormat.ZONE)
            .toInstant();
    Instant msg =
        ZonedDateTime.of(LocalDate.of(2026, 8, 21), LocalTime.of(9, 15), ChatTimeFormat.ZONE)
            .toInstant();
  ...
  void formatsOlderAsDayMonth() {
    Instant now =
        ZonedDateTime.of(LocalDate.of(2026, 8, 22), LocalTime.of(10, 0), ChatTimeFormat.ZONE)
            .toInstant();
    Instant msg =
        ZonedDateTime.of(LocalDate.of(2026, 8, 10), LocalTime.of(9, 15), ChatTimeFormat.ZONE)
            .toInstant();
