...
public class RoomController {
  ...
  public RoomDto updateGroupAvatar(
      @PathVariable UUID roomId, @RequestPart("file") MultipartFile file) {
  ...
  public void addMembers(@PathVariable UUID roomId, @Valid @RequestBody AddMembersRequest request) {
  ...
  public PinnedMessageDto pinMessage(
      @PathVariable UUID roomId, @Valid @RequestBody PinMessageRequest request) {
  ...
  public void relayTyping(
      @PathVariable UUID roomId, @RequestBody(required = false) TypingRequest request) {
  ...
  public RoomDto muteRoom(@PathVariable UUID roomId, @Valid @RequestBody MuteRoomRequest request) {
  ...
  public List<ReadReceiptDto> listMessageReceipts(
      @PathVariable UUID roomId, @PathVariable UUID messageId) {
    return chatService.listMessageReceipts(SecurityUtils.requireUserId(), roomId, messageId);
  }

  @GetMapping("/{roomId}/messages")
  public List<MessageDto> listMessages(
      @PathVariable UUID roomId, @RequestParam(defaultValue = "50") @Min(1) @Max(100) int limit) {
  ...
  public MessageDto sendMessage(
      @PathVariable UUID roomId, @Valid @RequestBody SendMessageRequest request) {
  ...
  @ResponseStatus(HttpStatus.NO_CONTENT)
  public void deleteMessage(@PathVariable UUID roomId, @PathVariable UUID messageId) {
  ...
  public WebhookCreatedDto createWebhook(
      @PathVariable UUID roomId, @Valid @RequestBody CreateWebhookRequest request) {
