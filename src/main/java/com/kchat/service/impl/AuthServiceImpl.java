...
public class AuthServiceImpl implements AuthService {
    ...
    /**
     * BCrypt hash used only to keep login timing similar when the user is missing
     * (value = bcrypt of "timing-dummy-password").
     */
    ...
    public VerifyRegistrationOtpResponse verifyRegistrationOtp(String email, String otp) {
        ...
        RegistrationOtpToken stored = registrationOtpTokenRepository
    ...
    public AuthResponse register(RegisterRequest request, String deviceToken) {
        ...
        RegistrationOtpToken otpToken = registrationOtpTokenRepository
    ...
    public void logout(LogoutRequest request) {
        refreshTokenRepository.findByTokenHashWithUser(TokenHasher.sha256Hex(request.refreshToken()))
    ...
    private void touchDevice(User user, String deviceToken) {
        ...
        UserDevice device = userDeviceRepository.findByFcmToken(normalized)
    ...
    private RefreshToken findUsableRefreshToken(String rawToken) {
        return refreshTokenRepository.findByTokenHashWithUser(TokenHasher.sha256Hex(rawToken))
