...
public class MailServiceImpl implements MailService {
    ...
    private static final ClassPathResource LOGO = new ClassPathResource("templates/mail/kchat-icon.png");
