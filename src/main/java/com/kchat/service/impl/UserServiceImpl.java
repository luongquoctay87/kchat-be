...
public class UserServiceImpl implements UserService {
    ...
    /**
     * Quiet hours are enabled iff both start and end are set.
    ...
    static void applyQuietHoursSettings(UserSettings settings, UpdateUserSettingsRequest request) {
        ...
        boolean alreadyOn = settings.getQuietHoursStart() != null && settings.getQuietHoursEnd() != null;
        boolean updatingHours = request.quietHoursStartHour() != null || request.quietHoursEndHour() != null;
        ...
        LocalTime start = request.quietHoursStartHour() != null
                ? hourToTime(request.quietHoursStartHour())
                : settings.getQuietHoursStart();
        LocalTime end = request.quietHoursEndHour() != null
    ...
    static void applyMessageStorageSettings(UserSettings settings, UpdateUserSettingsRequest request) {
        ...
        if (request.defaultDisappearingSeconds() != null) {
            ...
            if (request.defaultDisappearingSeconds() == MessageStorageOptions.CLEAR_DEFAULT_DISAPPEARING) {
    ...
    private UserSettingsDto toSettings(UserSettings settings) {
        boolean quietEnabled = settings.getQuietHoursStart() != null && settings.getQuietHoursEnd() != null;
    ...
    private static String formatDeviceSubtitle(String platform, Instant lastActiveAt, boolean isCurrent) {
        if (isCurrent) {
