...
public final class MediaHttp {
    ...
    public static ResponseEntity<Resource> inline(MediaStorage.ObjectStream object, String cacheControl) {
        String fileName = object.fileName() != null && !object.fileName().isBlank()
                ? object.fileName()
                : "file";
